defmodule ChromoidWeb.AdminSettingsControllerTest do
  ...
  describe "PUT /admins/settings/update_password" do
    test "updates the admin password and resets tokens", %{conn: conn, admin: admin} do
      new_password_conn =
        put(conn, Routes.admin_settings_path(conn, :update_password), %{
  ...
  describe "PUT /admins/settings/update_email" do
    ...
    test "updates the admin email", %{conn: conn, admin: admin} do
      conn =
        put(conn, Routes.admin_settings_path(conn, :update_email), %{
          "current_password" => valid_admin_password(),
