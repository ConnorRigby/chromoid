defmodule Chromoid.Administration.Admin do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Chromoid.Repo)
  ...
  """
  def valid_password?(%Chromoid.Administration.Admin{hashed_password: hashed_password}, password)
